...
-- Note: These are demo users for testing purposes

-- First, let's check if we have any existing demo users and clean them up
DELETE FROM auth.users WHERE email LIKE '%@demo.com';

-- Insert demo profiles directly (this will work since we have permissive policies)
